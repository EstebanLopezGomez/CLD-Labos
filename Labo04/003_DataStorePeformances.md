...
This time we are testing the application's form to surpass a high number of database insertions (50'000 requests). We still can se that there are some errors  
